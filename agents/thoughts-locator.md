...
**Note**: The thoughts/ directory is local to the project, created in the project root (gitignored).
...
- `thoughts/shared/research/api-performance.md` - Contains section on rate limiting impact
